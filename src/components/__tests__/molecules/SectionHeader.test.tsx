...
const MockHeading = ({ children, ...props }: { children?: React.ReactNode; [key: string]: any }) => (
  <Text testID="mock-heading" {...props}>{children}</Text>
);
...
const MockBadge = ({ children, ...props }: { children?: React.ReactNode; [key: string]: any }) => (
  <View testID="mock-badge" {...props}>{children}</View>
);

const MockBadgeText = ({ children, ...props }: { children?: React.ReactNode; [key: string]: any }) => (
  <Text testID="mock-badge-text" {...props}>{children}</Text>
);
...
describe('SectionHeader', () => {
  ...
  it('renders with title and subtitle', () => {
    const { getByText } = render(
      <SectionHeader title="Teams" subtitle="Premier League" />
    );
  ...
  it('renders with title and count', () => {
    const { getByText, getByTestId } = render(
      <SectionHeader title="Teams" count={20} />
    );
