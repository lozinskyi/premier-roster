...
const MockHStack = ({ children, testID = 'mock-hstack', ...props }: { children?: React.ReactNode; testID?: string; [key: string]: any }) => (
...
describe('TeamInfo', () => {
  ...
  it('renders with team name and founded year', () => {
    const { getByText, getByTestId } = render(
      <TeamInfo name="Arsenal FC" founded={1886} />
    );
